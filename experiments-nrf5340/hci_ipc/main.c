...
int main(void)
{
	...
	uint8_t *secret_data = (uint8_t *) 0x200006f5;
	uint32_t *func_ptr = (uint32_t *) 0x200002c4;
	printk("secret data: %s\n", secret_data);
	printk("func_ptr value before: 0x%08x\n", *func_ptr);
	printk("writing func_ptr\n");
	*func_ptr = 0xfa5;
	printk("func_ptr value after: 0x%08x\n", *func_ptr);
